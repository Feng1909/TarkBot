...
get_filename_component(_filename "/home/nuc_1/TarkBot/src/tarkbot_package/tarkbot_lidar/xtlidar_ros/srv/Control.srv" NAME_WE)
add_custom_target(_xtlidar_ros_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "xtlidar_ros" "/home/nuc_1/TarkBot/src/tarkbot_package/tarkbot_lidar/xtlidar_ros/srv/Control.srv" ""
)
...
_generate_srv_cpp(xtlidar_ros
  "/home/nuc_1/TarkBot/src/tarkbot_package/tarkbot_lidar/xtlidar_ros/srv/Control.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/xtlidar_ros)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/xtlidar_ros\")")
  # install generated code
  install(
