...
def side_flag_callback(msg):
	...
	if msg.data == [] or msg.data[0].frame_id == "Green_light":
		...
		# 	side_flag = 2
		if msg.data[0].ptx > 450 and msg.data[0].ptx < 500 and msg.data[0].pty < 200 and msg.data[0].pty > 180 and msg.data[0].disth > 45:
			side_flag = 2
	elif msg.data[0].frame_id == "Red_light":
		# if msg.data[0].ptx > 525 and msg.data[0].pty < 80: cam
		if msg.data[0].ptx > 540 and msg.data[0].pty < 175 and msg.data[0].pty > 155: 
			stop_flag = 1
			stop_temp = 0
	elif msg.data[0].frame_id == "Parking_lotB":
		# if msg.data[0].ptx > 455 and msg.data[0].pty > 115 and msg.data[0].distw < 50.0:
		if msg.data[0].ptx > 560 and msg.data[0].pty > 188 and msg.data[0].pty <200:
			park_flag = 1
