...
def side_flag_callback(msg):
	...
	if msg.data == [] or msg.data[0].frame_id == "Green_light":
		...
		# if msg.data[0].ptx > 530 and msg.data[0].pty < 150:
		# 	side_flag = 2
		if msg.data[0].ptx > 525 and msg.data[0].ptx < 580 and msg.data[0].pty < 165 and msg.data[0].pty > 150 and msg.data[0].disth > 45:
			side_flag = 2
	elif msg.data[0].frame_id == "Red_light":
		# if msg.data[0].ptx > 525 and msg.data[0].pty < 80: cam
		if msg.data[0].ptx > 520 and msg.data[0].pty < 150 and msg.data[0].pty > 135:  #pro
			stop_flag = 1
			stop_temp = 0
	elif msg.data[0].frame_id == "Parking_lotB":
		# if msg.data[0].ptx > 455 and msg.data[0].pty > 115 and msg.data[0].distw < 50.0:
		if msg.data[0].ptx > 510 and msg.data[0].pty > 150 and msg.data[0].pty <165 and msg.data[0].distw > 50.0 and msg.data[0].distw < 57.0:
			park_flag = 1
