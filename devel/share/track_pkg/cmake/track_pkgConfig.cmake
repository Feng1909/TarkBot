...
if("TRUE" STREQUAL "TRUE")
  set(track_pkg_SOURCE_PREFIX /home/nuc_1/TarkBot/src/tarkbot_demo/track_pkg)
  set(track_pkg_DEVEL_PREFIX /home/nuc_1/TarkBot/devel)
  ...
  set(track_pkg_INSTALL_PREFIX /home/nuc_1/TarkBot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'track_pkg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nuc_1/TarkBot/src/tarkbot_demo/track_pkg/${idir}'.  ${_report}")
    endif()
