...
if("TRUE" STREQUAL "TRUE")
  set(ar_track_alvar_msgs_SOURCE_PREFIX /home/nuc_1/TarkBot/src/tarkbot_demo/ar_track_alvar/ar_track_alvar_msgs)
  set(ar_track_alvar_msgs_DEVEL_PREFIX /home/nuc_1/TarkBot/devel)
  ...
  set(ar_track_alvar_msgs_INSTALL_PREFIX /home/nuc_1/TarkBot/install)
...
if(NOT "/home/nuc_1/TarkBot/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ar_track_alvar_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nuc_1/TarkBot/src/tarkbot_demo/ar_track_alvar/ar_track_alvar_msgs/${idir}'.  ${_report}")
    endif()
