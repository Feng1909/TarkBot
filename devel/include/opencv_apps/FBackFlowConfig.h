...
namespace opencv_apps
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(FBackFlowConfig &config, const FBackFlowConfig &max, const FBackFlowConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const FBackFlowConfig &config1, const FBackFlowConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, FBackFlowConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const FBackFlowConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, FBackFlowConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const FBackFlowConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const FBackFlowConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, FBackFlowConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
