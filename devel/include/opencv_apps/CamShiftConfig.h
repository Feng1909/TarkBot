...
namespace opencv_apps
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(CamShiftConfig &config, const CamShiftConfig &max, const CamShiftConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const CamShiftConfig &config1, const CamShiftConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, CamShiftConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const CamShiftConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, CamShiftConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const CamShiftConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const CamShiftConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, CamShiftConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
